...
export default function Donate() {
  ...
  return (
    <>
      ...
      <div className="helpus-bg md:w-[95vw] w-full">
        <div className="lg:max-w-[1175px] lg:mx-auto mx-10 md:mx-20 pb-10 ">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="pt-16 w-auto md:w-[40%] ">
              <p className="lg:text-[30px] font-bold text-2xl leading-tight ">
              ...
              <h3 className="lg:text-[18px] pt-8 text-[#333333] leading-tight ">
                ...
                their soft skill and technical knowledge. <br />
                <br />
                With your gift, In the coming Ethiopian New year 2015, we plan
                to teach 100 students across 4 cities in Ethiopia in giving
                100hrs of coding training. Hence, we are launching our first
                ever donation campaign, in which $100 can cover a student's full
                training session.
              </h3>
            </div>
            <div className=" w-[75%] md:w-[45%] pt-16 flex flex-col gap-2">
              ...
              <div className="md:w-96 w-36 flex flex-col">
                ...
                >
                  <option className="text-sm md:text-lg">Ethiopia</option>

                  <option className=" text-sm md:text-lg">International</option>
                </select>
              </div>
              {country !== "" &&
                (country === "International" ? (
                  <div className=" w-full flex flex-col">
                    ...
                    {email.length < 1 && name.length < 1 && (
                        <p className="p-1 text-red-600 w-50 min-w-max ">
                          Fill the required fields first.
                        </p>
                      )}
                  </div>
                ) : (
                  <div className="md:space-y-3 pt-10 ">
                    <button
                      onClick={() => handleData()}
                      className=" md:text-xl text-lg disabled:bg-gray-400 text-white md:px-3 px-3 py-3 rounded bg-[#42855B]"
                      disabled={
                        email.length === "" ||
                        email.length == 0 ||
                        name.length == 0 ||
      ...
      <div className=" w-full md:w-[1345px] bg-[#f6f9ff] lg:mx-auto mt-3">
        <div className="flex flex-col md:justify-items-center gap-1">
          <div className="pt-4 w-full mb-16">
            <p className="lg:text-[30px] pt-8 text-2xl text-center md:text-left md:pl-12 font-bold leading-tight ">
              Where is the donation going?
            </p>
            <p className="text-lg text-gray-600 pt-4 text-center md:text-left md:pl-12 leading-tight ">
              Here's how we do it: you contribute to the cost, and we supply our
              excellent curriculum and best trainers to provide the best quality
              training <br /> for the students.{" "}
            </p>

            <div className="flex flex-col md:flex-row items-center md:pl-16 pt-12">
              <div className="md:w-[35%] md:pt-0 pt-4 w-80">
              ...
              <div className="md:w-[50%] pt-9 md:pt-0 w-96">
                <div className="pt-9 ml-20 md:ml-24 flex flex-col gap-3">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>Monitoring and Evaluation and Trainer fee.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
              ...
              <div className="md:w-80 w-72 pt-20 md:pt-0 md:mr-36">
                <Chart />
              </div>
            </div>
          </div>
      ...
      <div className="md:max-w-[1220px] w-full lg:mx-auto mt-16 pb-8">
        <div className="w-full md:pt-10 pt-0">
          <div className="">
            <ContentDonate />
          </div>
        </div>
      </div>
      <div className="lg:max-w-[1240px] w-full md:mx-auto mt-9 pb-8 md:mb-10">
        <div className="w-full pl-2 md:pl-4 pt-8">
          <div className="md:w-[100%] w-[90%] mx-auto">
            <h2 className="lg:text-[30px] text-2xl pb-5 font-bold leading-tight ">
              About this Course
            </h2>
            <p className="text-lg text-gray-600">
              Our Curriculum is structured into 9 levels, beginning from Basic
              Digital Literacy to AI and Machine Learning. These beginner
              friendly levels <br /> are designed in a fun and easy way to
              introduce the world of programming. For this donation program, we
              are only providing Level 0: <br /> Digital Literacy and Level 1:
              Programming Scratch. <br />
            </p>

            {level !== null && level === 0 && (
              <>
                <p className="text-lg text-gray-600 pt-10">
                  Level 0: Basic Digital Literacy: An introduction to basic
                  digital skills such as; using the internet, social media
                  usage, sending an email and <br /> conducting research
                  including, employability and life skills training.
                </p>
                <IoIosArrowUp className="mt-5" onClick={setLevel} />
              </>
            )}

            {level !== null && level === 1 && (
              <>
                <p className=" text text-lg text-gray-600 pt-10">
                  {" "}
                  Level 1: Programming Scratch: Scratch is a beginner friendly
                  block-based programming language developed by MIT. Students
                  will utilize <br /> Scratch to learn the basics of computer
                  programming by creating educational and interactive
      ...
      <div className="md:max-w-[1300px] w-full px-6 md:px-0  mx-auto py-10">
        <div className="grid md:pl-10 md:grid-cols-2 grid-cols-1  gap-4">
          <div className="space-y-3 pl-2 py-6">
          ...
          <div className="relative   h-auto w-auto hidden lg:block mr-3">
            <Image
              src="/impactss.jpg"
              objectFit="contain"
              // width={780}
