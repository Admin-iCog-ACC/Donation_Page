  ...
  return (
    ...
    With your gift, In the
            ...
            <div className=" w-[75%] md:w-[45%] pt-16 flex flex-col gap-2">
              ...
              {country !== '' && email.length>1 && name.length>1 &&
      ...
      <div className=" w-full md:w-[1225px] shadow-sm bg-[#f6f9ff] lg:mx-auto mt-3 ">
        <div className="flex flex-col md:justify-items-center gap-1">
          <div className="pt-4 w-full mb-16">
            ...
            <div className="flex flex-col md:flex-row items-center md:pl-12 pt-7">
              <div className="md:w-80 w-72 ">
                <Chart />
              </div>

              <div className="md:w-[50%] pt-9 md:pt-0 w-96 md:ml-5 lg:ml-16">
                <div className="pt-9 ml-20 flex flex-col gap-3">
      ...
      <div className="lg:max-w-[1225px]  w-full shadow-md md:mx-auto mt-16 pb-12 md:mb-10">
        <div className="w-full pl-2 md:pl-2 pt-8">
      ...
      <div className="md:max-w-[1225px] w-[100%]  mx-auto bg-[#f6f9ff] shadow-md py-10 mb-10">
        <div className="grid md:pl-10 pl-5 md:grid-cols-2 grid-cols-1  gap-4">
          <div className="space-y-3 pl-1 py-6">
