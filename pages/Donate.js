        ...
        <div className="w-[75%] pl-28 pt-8">
          <div className="">
            ...
            <p className="text-lg text-gray-600">
              FUN and EASY introduced to the world of programming 
              Applying theoretical knowledge into a problem-solving real-time project <br/>
             </p> 

              {level !== null && level === 0 && <p className="text-lg text-gray-600 pt-10">Level 0: Basic Digital Literacy: The training starts at level 0
              ...
              develop creative thinking, decision making, critical thinking, and
              effective communication which will in turn insure an equipped
              individual to combat the 21st century technical competition
              demand.</p>}

              {level !== null && level ===1 && <p className="text-lg text-gray-600 pt-10">  Level 1: Programming Scratch: The students will then move
              to Level 1 Basic Scratch. Scratch is a beginner friendly
              ...
              Continuous Assessment Test (CAT) and will be certified for Level 1
              Basic Scratch. </p>}      
