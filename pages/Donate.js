  ...
  return (
    <>
      ...
      <div className=" helpus-bg ">
        <div className="max-w-[1225px] lg:mx-auto  mx-20 pb-10 ">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="pt-24 w-auto md:w-[40%] ">
              <p className="lg:text-[25px] font-semibold text-lg text-[#333333] leading-tight ">
                 With your gift, anyone can code! 
              </p>
              <h3 className="lg:text-[18px] pt-8 text-[#333333] leading-tight ">
              Our New Year’s donation campaign is an opportunity for you to give a gift for a student and 
              make your contribution in building their soft skill and technical knowledge. With your gift, 
              In the coming Ethiopian New year 2015, we plan to teach 100 students across 4 cities in Ethiopia 
              in giving 100hrs of coding training. Hence, we are launching our first ever donation campaign, 
              in which $100 can cover a student's full training session. 

              </h3>
            </div>
            <div className=" w-full md:w-[45%] pt-8 flex flex-col gap-2">
      ...
      <div className="max-w-[1225px] bg-[#f6f9ff] lg:mx-auto mt-3 ">
        <div className="flex justify-items-center gap-1">
          <div className="pt-4 w-full mb-16">
            ...
            <div className="flex  pl-24 pt-7">
              <div classsName="w-[40%] flex">
                <Chart />
              </div>

              <div className="w-[50%] pl-16">
                <div className="relative md:h-[200px] pt-9 pl-10 ">
      ...
      <div className="max-w-[1225px] shadow-md lg:mx-auto mt-16 pb-20">
      ...
      <div className="max-w-[1225px] shadow-md lg:mx-auto mt-16 pb-12 mb-10">
        <div className="w-[75%] pl-28 pt-8">
          <div className="">
            <h2 className="lg:text-[30px] text-lg pb-5 font-bold leading-tight ">
              About this Course
            </h2>
            <p className="text-lg text-gray-600">
             Our Curriculum is structured into 9 levels, beginning from Basic Digital Literacy to AI and Machine Learning. These beginner friendly levels are designed in a fun and easy way to introduce the world of programming. 
              For this donation program, we are only providing  Level 0: Digital Literacy and Level 1: Programming Scratch.  <br/>
             </p> 

              {level !== null && level === 0 && <p className="text-lg text-gray-600 pt-10">Level 0: Basic Digital Literacy: An introduction to basic digital skills such as; using the internet, 
                social media usage, sending an email and conducting research including, employability and life skills training. </p>}

              {level !== null && level ===1 && <p className="text-lg text-gray-600 pt-10">  Level 1: Scratch is a beginner friendly block-based programming language developed by MIT. 
              Students will utilize Scratch to learn the basics of computer programming by creating educational and interactive animations, games, etc.  </p>}      
      ...
      <div className="max-w-[1225px] mx-auto bg-[#f6f9ff] shadow-md  px-5 py-10 mb-10">
        <div className="grid grid-cols-2 pl-24  gap-4">
          <div className="space-y-3 py-6" >
            <h2 className="text-4xl font-bold pb-5">Impact </h2>
            <p className="text-lg text-gray-600">
            The School network is one wing of the Tech-Education programs that we do,  
            where we are giving our training to students on their after-school programs, 
            weekends and during school breaks by utilizing their school’s ICT laboratories to conduct training.
            With 5+ years of experience implementing this type of project, we have impacted over  
            1200 public school students in 20 public schools in 8 cities of Ethiopia. 
            </p>
          </div>
